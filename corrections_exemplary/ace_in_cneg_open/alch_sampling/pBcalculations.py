...
def DGcalculator(lambdas, charges, conditions):
  ...
  for lam in range(1,len(lambdas)):
    ...
    for atom in range(0, len(charges[lam])):
      ...
      #print(charges[len(lambdas)-1][atom])
...
def main():
  if (len(sys.argv) == 1 or len(sys.argv) % 2 != 0):
    print 'USAGE:\n\n ./pBcalculations.py LamA FileA LamB FileB ... scheme\n'
    print '  FileX ... Output file from dGslv_pbsolv at LamX'
